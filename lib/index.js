...
var paramsValidate = function() {
  ...
  var types = [ "ignore", "w+", "S+", "number", "posNumber", "integer", "string", "either", "object", "array", "price", "toLower"];
      ...
      switch (type) {
        ...
        case "w+":
          ...
          if (! re.test( given[key])) {
            var temp =  { };
            temp[key] = "must contain word characters";
            errors.push(temp);
          }
          break;
        ...
        case "S+":
          ...
          if (! re.test( given[key])) {
            var temp =  { };
            temp[key] = "must not contain spaces";
            errors.push(temp);
          }
          break;
        ...
        case "string":
          ...
          if (! given[key].toString().length > 0) {
            temp[key] = "must have a length";
          }
